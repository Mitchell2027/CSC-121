#Program manages company employees and departments with writing txt and csv files (Main.py)
#Mariah Mitchell
#CSC-121
#11 Nov 2025

import m6LAB_Mariah_Mitchell_Functions as fn
def menu():
    """
...
def main():
    ...
    while choice != "8":
        if choice == "1":
            ...
            if valid_id:
               # If loop to validatet ID
               fn.get_employee_info(valid_id)
